...
%
%  author        : david vallado  719-573-2600   04 jun 2002
...
rtod = st*rpef;  % True Equator of Date (TOD) 

vpef = pm*vecef;
vtod = st*(vpef + cross(omegaearth,rpef));

atod = st*( pm*aecef + cross(omegaearth,cross(omegaearth,rpef)) ...
