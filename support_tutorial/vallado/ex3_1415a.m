...
%    book example
           ...
           [rteme,vteme,ateme] = ecef2teme  ( recef,vecef,aecef,ttt,jdut1+jdut1frac,lod,xp,yp,1 );
           fprintf(1,'ecef-teme %14.7f%14.7f%14.7f',rteme );
           fprintf(1,' v %14.9f%14.9f%14.9f',vteme );
           fprintf(1,' a %14.9f%14.9f%14.9f\n',ateme );

           % -------- teme2ecef    - transform teme to ecef vectors
           [rj2,vj2,aj2] = teme2ecef( rteme,vteme,ateme,ttt,jdut1+jdut1frac,lod,xp,yp,1 );
...
%           ddeps = 0.0;
           ...
           [recef,vecef,aecef] = teme2ecef( rteme',vteme',ateme,ttt,jdut1+jdut1frac,lod,xp,yp,1);
