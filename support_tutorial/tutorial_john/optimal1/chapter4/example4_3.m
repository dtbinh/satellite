% This example uses a least squares differential correction
% algorithm to determine the orbit of a spacecraft from
% range, azimuth and elevation measurements. It outputs an 
% approximate solution using the Herrick-Gibbs approach, 
% the true values and the least squares iterations.
...
% Other Required Routines: orbitfun.m, orbit_initial.m, vecnorm.m, orbit_det.m, orb_prop.m
