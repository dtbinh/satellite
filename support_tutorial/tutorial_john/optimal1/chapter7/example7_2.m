...
w=[-inv(90/(2*pi)*60)*ones(m,1) zeros(m,1) zeros(m,1)];
...
subplot(311)
plot(t/60,sig3(:,1),t/60,erre(:,1),t/60,-sig3(:,1));
set(gca,'Fontsize',12);
ylabel('Roll (Deg)')
grid
...
subplot(312)
plot(t/60,sig3(:,2),t/60,erre(:,2),t/60,-sig3(:,2));
set(gca,'Fontsize',12);
ylabel('Pitch (Deg)')
grid
axis([0 90 -0.002 0.002])
...
set(gca,'Ytick',[-0.002 -0.001 0 0.001 0.002])
subplot(313)
plot(t/60,sig3(:,3),t/60,erre(:,3),t/60,-sig3(:,3));
set(gca,'Fontsize',12);
ylabel('Yaw (Deg)')
grid
axis([0 90 -0.02 0.02])
