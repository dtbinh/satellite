...
% To provide the scan pattern, the
% spacecraft spins about the z-axis at 0.464 rpm, and the z-axis cones about the Sunline
% at 1 rev/h. A 22.5deg+-0.25deg angle between the z-axis and the Sun direction
% must be maintained to provide a constant power input, and to provide constant
% temperatures for alignment stability and science quality.
