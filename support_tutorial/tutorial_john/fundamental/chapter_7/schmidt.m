function [y,t]=schmidt(x,thresh,minwid)
% Pass input signal X through a schmitt trigger
% SCHMIDT(X,[LOW HIGH]) gives low and high thresholds. LOW and HIGH can be
% scalars or can be vectors specifiying different thresholds for each X element.
%
% SCHMIDT(X,HYSTERESIS) specifies the thresholds as MAX-DELTA and MIN+DELTA where
...
% For [Y,T]=SCHMIDT(...) Y contains alternate +1 and -1 values and T contains
% the sample numbers at which X crossed the thresholds.


%      Copyright (C) Mike Brookes 1998
%      Version: $Id: schmitt.m,v 1.3 2005/02/21 15:22:14 dmb Exp $
%
