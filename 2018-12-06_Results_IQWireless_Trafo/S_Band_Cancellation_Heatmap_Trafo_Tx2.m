...
[XI,YI] = meshgrid((0:0.1:360),(-90:0.1:90)); %gr????ere Matrix Koordianten bauen
ZI = interp2(X,Y,Heatmap,XI,YI); %originale matrix auf gr????ere interpolieren wenn Heatmap 181x361 anstelle von 361x181
...
print('\\bst-server3c\Projekte\Systeme\STM_Lagari\03-Documents\TR-Test-Reports\TR003_TTC_AntennaCancellation\src\2018-12-06_Results_IQWireless_Trafo\Cancellation_Pattern_Tx2.pdf','-S720,360') % erzeugt ein PDF mit 72 DPI mit 10x5 inch Groesse
