...
plot(tout,w_B_BI_error_skf(1,:)*R2D,'k-.')
ylabel('x [\circ/s]');
xlabel('time [s]');
axis([-Inf Inf ymin ymax])
...
plot(tout,w_B_BI_error_skf(2,:)*R2D,'k-.')
ylabel('y [\circ/s]');
xlabel('time [s]');
axis([-Inf Inf ymin ymax])
...
plot(tout,w_B_BI_error_skf(3,:)*R2D,'k-.')
ylabel('z [\circ/s]');
xlabel('time [s]');
axis([-Inf Inf ymin ymax])
...
plot(tout,bias_error_skf(1,:)*R2D,'k-.')
...
plot(tout,bias_error_skf(2,:)*R2D,'k-.')
...
plot(tout,bias_error_skf(3,:)*R2D,'k-.')
