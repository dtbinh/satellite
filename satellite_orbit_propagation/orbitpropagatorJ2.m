% This script runs the orbit propagation of a small satelltie using TLE
% data with the effect of J2 oblateness of the earth.
% 
% Revision :
%   rusty   -Initiate       09 Jul 2018
% Reference: 
...
J2      = 0.0010836;
we      = 360*(1 + 1/365.25)/(3600*24);      % [deg/s] Earth's rotation 
